...
<body>
  ...
  <ul id="slide-out" class="sidenav " >
    <li><div class="user-view">
      ...
      <li><a href="{{route('admin.dashboard')}}"><i class="material-icons">shopping_cart</i>Pedidos</a></li>
      <li><a href="{{route('admin.dashboard')}}"><i class="material-icons">bookmarks</i>Categorias</a></li>
      <li><a href="{{route('admin.dashboard')}}"><i class="material-icons">peoples</i>Usuários</a></li>
  </ul>
